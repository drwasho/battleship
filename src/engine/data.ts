...
export const SHIPS: ShipTemplate[] = [
  // Movement is inversely proportional to ship size (smaller ships are faster)
  { id: 'scout', name: 'Scout', size: 2, move: 4, gunCount: 1 },
  { id: 'destroyer', name: 'Destroyer', size: 3, move: 3, gunCount: 2 },
  { id: 'cruiser', name: 'Cruiser', size: 3, move: 3, gunCount: 3 },
  { id: 'battleship', name: 'Battleship', size: 4, move: 2, gunCount: 4 },
